...
namespace KSTAR.Controllers
{
    public class FGroupsController : Controller
    {
        ...
        {
            return View(_context.ForumGroup.ToList());
        }
        ...
        public IActionResult Details(int? id)
        {
            ...
            FGroup fGroup = _context.ForumGroup.Single(m => m.ID == id);
            if (fGroup == null)
            {
                return HttpNotFound();
            }
        ...
        public IActionResult Create(FGroup fGroup)
        {
            ...
            {
                _context.ForumGroup.Add(fGroup);
        ...
        {
            FGroup fGroup = _context.ForumGroup.Single(m => m.ID == id);
            _context.ForumGroup.Remove(fGroup);
            _context.SaveChanges();
            return RedirectToAction("Index");
        }
    }
